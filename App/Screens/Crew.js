...
const Home = ({ navigation, route }) => {
    ...
    const [selectedValue1name, setselectedValue1name] = useState('');
    ...
    const apiCall_proprtylist = async () => {
        ...
        Axios.get(Urls.baseUrl + 'api/property/', { headers })
            .then(response => {
                ...
                apiCall(updatedCarsArray2[0].pk)
   ...
   const apiCall_Delete = async (pkk) => {
    ...
    Axios.delete(Urls.baseUrl + 'api/crew/' + pkk, { headers })
        .then(response => {
                            ...
                            <TouchableOpacity
                                ...
                                <View style={{ marginTop: 15, flexDirection: 'row', width: '100%' }}>
                                    ...
                                    <TouchableOpacity onPress={() => {
                                        ...
                                        <Text style={[Style.text14, { marginTop: 3, textAlign: 'center', color: Colors.white }]}>Delete</Text>
                                    </TouchableOpacity>
                                        ...
                                        <ScrollView contentContainerStyle={{ flex: 1, justifyContent: 'center', padding: 20 }}>
                                            <View >
                                                ...
                                                <View style={{ paddingVertical: "4%" }}>
                                                 {
                                                console.log('33',selectedValue) 

                                                 }
                                                  {
                                                      selectedValue  === '' ?  <Text style={[Style.text14, { fontFamily: CustomeFonts.Poppins_Bold, marginBottom: 6, color: Colors.lightblack, }]}>Select Property</Text> : null

                                                  }

                                                  {
                                                      selectedValue  === '' ?                                       <View style={{ borderColor: Colors.lightblack, borderWidth: 1, borderRadius: 6, }}>
                                                      {
                                                          userArray.length > 0 ?
                                                              <>
                                                                  <Picker
